...
**For Initiating a Single Call...**
Example:
- HULLO 00, this is 10, MESSAGE, OVER.

**For Initiating a Multiple Call**
You need to include AND for each respective station.
Example:
- HULLO 20 and 30 and 40, thus is 10, MESSAGE, OVER.

**For Initiating a Collective Call**
You need to include CHARLIE CHARLIE.
Example:
- HULLO CHARLIE CHARLIE BRAVO, this is 10, MESSAGE, OVER.

**For Initiating a All Stations Call**
You need to include the Net Identification Sign.
Example:
